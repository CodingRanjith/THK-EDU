...
export function buildInternOfferLetterBody(d) {
  ...
  return `
      ...
      <p style="${p}">A Certificate of Completion will be issued only after successfully completing the internship criteria and assigned work.</p>
      ...
      <p style="margin:0;text-align:justify;">We look forward to seeing your active participation and contribution during your internship period. Welcome to <strong>Techackode!</strong></p>`
}
